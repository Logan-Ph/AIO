...
y0_fomular= x_fomular[0][0] + x_fomular[1][0] * x0_gd + x_fomular[2][0]*x0_gd**2
plt.plot(x0_gd,y0_fomular, color="black")

x_init = np.array([[-21.00859126],
				  [8.2104085039],
				  [-0.4097458703]])
y0_init = x_init[0][0] + x_init[1][0]*x0_gd + x_init[2][0]*x0_gd**2
plt.plot(x0_gd,y0_init, color="blue")
